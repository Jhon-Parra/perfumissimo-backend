...
const updateSettings = async (req, res) => {
    try {
        const { hero_title, hero_subtitle, hero_media_type, accent_color, show_banner, banner_text, banner_accent_color, logo_height_mobile, logo_height_desktop, instagram_url, instagram_access_token, facebook_url, whatsapp_number, whatsapp_message, envio_prioritario_precio, perfume_lujo_precio, email_from_name, email_from_address, email_reply_to, email_bcc_orders, boutique_title, boutique_address_line1, boutique_address_line2, boutique_phone, boutique_email, seller_bank_name, seller_bank_account_type, seller_bank_account_number, seller_bank_account_holder, seller_bank_account_id, seller_nequi_number, seller_payment_notes, wompi_env, wompi_public_key, wompi_private_key } = req.body;
